...
In order to find the derivative of the functional \eqref{LOLF}, we need to find the derivative of the Parzen window, as explaned in \sref{section:OLder}. The derivative is found to be
